...
@section('content')
      ...
      <section id="main-content">
          <section class="wrapper">
            <b><h3></i>&nbsp&nbsp&nbsp Data Kelas</h3></b>
                <div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              <h4></i>&nbsp&nbsp&nbsp Data Kelas</h4>
...
<div class="container">
  ...
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Tambah Kelas</button>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      {{csrf_field()}}
        ...
        <input type="text" name="b" class="form-control" required="unique">
